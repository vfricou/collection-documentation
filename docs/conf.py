...
project = 'vfricou Ansible collections'
copyright = 'Vincent FRICOU'

title = 'vfricou Ansible Collections Documentation'
html_short_title = 'vfricou Ansible Collections Documentation'
